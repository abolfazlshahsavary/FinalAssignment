...
\paragraph{to open selected file usinf zathura we can use this command I explane any part of commands above instead of \texttt{cat-}this command is used to pass stdin to zathura to open and load your selected file}
